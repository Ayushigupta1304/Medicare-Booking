...
const socialLinks = [
  {
    path: "https://www.youtube.com/@SihHackathon2023",
    icon: <FaYoutube className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://github.com/Ayushigupta1304",
    icon: <FaGithub className="group-hover:text-white w-4 h-5" />,
  },
  {
    path: "https://www.linkedin.com/in/ayushi-gupta-2b6a03262",
        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
          <div>
            ...
            <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">
              Copyright developed by ayushi all rights reserved
            </p>
