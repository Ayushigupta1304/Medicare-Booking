              ...
              <div>
               ...
               leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded"
                ...
                <p className="text_para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
                  ...
                  Dolores, omnis temporibus rerum saepe a blanditiis similique
                  eaque. Ipsa praesentium consequatur error natus at soluta
                  quisquam, consequuntur veniam perferendis laboriosam in!
                </p>
              </div>
            </div>
